...
-- Seed some rides data (using point type instead of geography)
...
(gen_random_uuid(), 'CBD Nairobi', 'JKIA Airport', POINT(36.8219, -1.2921), POINT(36.9278, -1.3194), 'taxi', 1500, 'pending', now()),
(gen_random_uuid(), 'Westlands', 'Karen', POINT(36.8100, -1.2676), POINT(36.7073, -1.3197), 'taxi', 800, 'pending', now()),
(gen_random_uuid(), 'Eastleigh', 'CBD Nairobi', POINT(36.8417, -1.2721), POINT(36.8219, -1.2921), 'matatu', 300, 'pending', now());
...
-- Update driver locations with some sample coordinates around Nairobi (using point type)
