...
-- Insert sample drivers (using only valid vehicle_type enum values)
...
(gen_random_uuid(), '+254701234570', 'DL001237', 'KBX 012D', 'Toyota', 'Probox', 2017, 'truck', true, true, 'available', 4.6),
