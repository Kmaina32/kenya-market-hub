...
-- Seed some rides data (using correct enum values)
...
(gen_random_uuid(), 'Eastleigh', 'CBD Nairobi', POINT(36.8417, -1.2721), POINT(36.8219, -1.2921), 'matatu', 300, 'requested', now());
