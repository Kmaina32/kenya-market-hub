...
const AdminSidebar = ({ isMobileOpen, onMobileClose }: AdminSidebarProps) => {
  ...
  const businessItems = [
    ...
    { icon: Wrench, label: 'Service Providers', path: '/service-providers', badge: '2' },
    { icon: Building2, label: 'Employers', path: '/employers', badge: null },
    { icon: UserCheck, label: 'Agents', path: '/agents', badge: null }
  ];

  const servicesItems = [
    { icon: Car, label: 'Rides', path: '/rides', badge: null },
    ...
    { icon: Briefcase, label: 'Jobs', path: '/jobs', badge: null }
  ];
