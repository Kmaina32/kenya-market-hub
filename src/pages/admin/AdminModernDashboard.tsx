                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-green-600 mt-1">
                      {stats?.userGrowthPercentage > 0 ? '+' : ''}{stats?.userGrowthPercentage?.toFixed(1) || 0}% from last month
                    </p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-green-600 mt-1">
                      {stats?.revenueGrowthPercentage > 0 ? '+' : ''}{stats?.revenueGrowthPercentage?.toFixed(1) || 0}% from last month
                    </p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-green-600 mt-1">
                      {stats?.orderGrowthPercentage > 0 ? '+' : ''}{stats?.orderGrowthPercentage?.toFixed(1) || 0}% from last month
                    </p>
                  </div>
